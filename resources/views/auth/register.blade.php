                ...
                <x-auth.header-card/>
                  ...
                  <div class="grid grid-cols-2 gap-4">
                      ...
                      <div class="col-span-full">
                          <div class="relative">
                            <x-auth.input-text type="text" id="name" placeholder="John" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                            <x-auth.input-label for="name">Firstname</x-auth.input-label>
                      ...
                      <div class="col-span-full">
                          ...
                          <div class="mt-4 relative">
                            <x-auth.input-text type="email" id="email" placeholder="example@gmail.com" name="email" :value="old('email')" required autofocus autocomplete="username" />
                            <x-auth.input-label for="email">Email</x-auth.input-label>
                      ...
                      <div class="col-span-full">
                          <!-- Password -->
                          <div class="mt-4 relative">
                            <x-auth.input-text type="password" id="password" placeholder="********" name="password" required autofocus autocomplete="new-password" />
                            <x-auth.input-label for="password">Password</x-auth.input-label>
                              <x-input-error :value="__('Password')" :messages="$errors->get('password')" class="mt-2" />
                          </div>
                      </div>
                      ...
                      <div class="col-span-full">
                          ...
                          <div class="mt-4 relative">
                            <x-auth.input-text type="password" id="password_confirmation" placeholder="********" name="password_confirmation" required autofocus autocomplete="new-password" />
                            <x-auth.input-label :value="__('Confirm Password')" for="password_confirmation" >Confirm password</x-auth.input-label>
